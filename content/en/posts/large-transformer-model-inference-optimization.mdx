...
![](/images/large-transformer-model-inference-optimization/distillation.png)
...
![](/images/large-transformer-model-inference-optimization/quantization-experiment-table.png)
...
![](/images/large-transformer-model-inference-optimization/OPT-models-outlier.png)
...
![](/images/large-transformer-model-inference-optimization/LLM-int8.png)
...
![](/images/large-transformer-model-inference-optimization/quantization-granularity.png)
...
![](/images/large-transformer-model-inference-optimization/SmoothQuant.png)
...
![](/images/large-transformer-model-inference-optimization/2-to-4-sparsity.png)
...
![](/images/large-transformer-model-inference-optimization/permutation-QK.png)
...
![](/images/large-transformer-model-inference-optimization/permutation-FFN.png)
...
![](/images/large-transformer-model-inference-optimization/N-to-M-sparsity-permutation-algo.png)
...
![](/images/large-transformer-model-inference-optimization/SR-STE.png)
...
![](/images/large-transformer-model-inference-optimization/Top-KAST-stabilize.png)
...
$$
L_\text{penalty}(\alpha^t_i) = \begin{cases} \vert \theta^t_i\vert & \text{ if } i \in A^t \\
...
![](/images/large-transformer-model-inference-optimization/scaling-transformer-speedup-table.png)
...
![](/images/large-transformer-model-inference-optimization/sparse-FFN.png)
...
$$
y*{s,m} = \sum_i x_i D*{i,s} E*{i,m} \quad\text{where }D \in \mathbb{R}^{d*\text{model} \times S}, D \in \mathbb{R}^{d_\text{model} \times M}
$$
...
![](/images/large-transformer-model-inference-optimization/sparse-QKV.png)
...
![](/images/large-transformer-model-inference-optimization/BPR.png)
...
![](/images/large-transformer-model-inference-optimization/PR-MoE.png)
...
![](/images/large-transformer-model-inference-optimization/efficient-transformer.png)
