---
title: "Graphs and PageRank"
date: 2014-02-01
description: "Graphs and PageRank"
authors:
...
![](/images/graphs-and-pagerank/HP_union_size_larger.png)
...
![](/images/graphs-and-pagerank/explanation.png)
...
![](/images/graphs-and-pagerank/example-graph.svg)
...
![Small labeled graph of top Harry Potter stories](/images/graphs-and-pagerank/HP-basic.png)
...
![](/images/graphs-and-pagerank/HP-basic-clique.png)
...
![](/images/graphs-and-pagerank/graph-HP-blank.png)
...
![](/images/graphs-and-pagerank/graph-HP-lang-labeled.png)
...
![](/images/graphs-and-pagerank/graph-HP-ships-labeled.png)
...
![](/images/graphs-and-pagerank/graph-HP-slash-labeled.png)
...
![](/images/graphs-and-pagerank/graph-NAR-blank.png)

Graph of top Naruto fanfiction (1,123 nodes and 4,000 edges)

We can look at languages again:

![](/images/graphs-and-pagerank/graph-NAR-lang-labeled.png)

Graph of top Naruto fanfiction, colored by language

And also for ships:

![](/images/graphs-and-pagerank/graph-NAR-ships-labeled.png)
...
![](/images/graphs-and-pagerank/graph-TWI-blank.png)

Graph of top Twilight fanfiction (1,031 nodes, 5,000 edges)

We can color it by language:

![](/images/graphs-and-pagerank/graph-TWI-lang-labeled.png)

Graph of top Twilight fanfiction, colored by language

And by ship:

![](/images/graphs-and-pagerank/graph-TWI-ships-labeled.png)
