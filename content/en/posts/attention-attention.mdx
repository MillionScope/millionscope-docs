...
![shiba](/images/attention-attention/shiba-example-attention.png)
...
![sentence](/images/attention-attention/sentence-example-attention.png)
...
![encoder-decoder model with additive attention layer](/images/attention-attention/encoder-decoder-example.png)
...
![encoder-decoder model with additive attention layer](/images/attention-attention/encoder-decoder-attention.png)
...
![alignment matrix](/images/attention-attention/bahdanau-fig3.png)
...
![intra-attention](/images/attention-attention/cheng2016-fig1.png)
...
![show-attend-and-tell](/images/attention-attention/xu2015-fig6b.png)
...
![global-local-attention](/images/attention-attention/luong2015-fig2-3.png)
...
![turing-machine](/images/attention-attention/turing-machine.jpg)
...
![turing-machine](/images/attention-attention/NTM.png)
...
![shift-weighting](/images/attention-attention/shift-weighting.png)
...
![NTM-flow-addressing](/images/attention-attention/NTM-flow-addressing.png)
...
![pointer network](/images/attention-attention/ptr-net.png)
...
![multi-head scaled dot-product attention](/images/attention-attention/multi-head-attention.png)
...
![Transformer encoder](/images/attention-attention/transformer-encoder.png)
...
![Transformer decoder](/images/attention-attention/transformer-decoder.png)
...
![Transformer model](/images/attention-attention/transformer.png)
...
![SNAIL](/images/attention-attention/snail.png)
...
![Conv vs self-attention on images](/images/attention-attention/conv-vs-self-attention.png)
...
![SAGAN](/images/attention-attention/SAGAN.png)
...
![SAGAN examples](/images/attention-attention/SAGAN-examples.png)
