...
![](/images/from-autoencoder-to-beta-vae/autoencoder-architecture.png)
...
![](/images/from-autoencoder-to-beta-vae/denoising-autoencoder-architecture.png)
...
![](/images/from-autoencoder-to-beta-vae/kl-metric-sparse-autoencoder.png)
...
![](/images/from-autoencoder-to-beta-vae/k-sparse-autoencoder.png)
...
![](/images/from-autoencoder-to-beta-vae/VAE-graphical-model.png)
...
![](/images/from-autoencoder-to-beta-vae/forward_vs_reversed_KL.png)
...
![](/images/from-autoencoder-to-beta-vae/reparameterization-trick.png)
...
![](/images/from-autoencoder-to-beta-vae/vae-gaussian.png)
...
![](/images/from-autoencoder-to-beta-vae/VQ-VAE.png)
...
![](/images/from-autoencoder-to-beta-vae/VQ-VAE-2.png)
...
![](/images/from-autoencoder-to-beta-vae/VQ-VAE-2-algo.png)
...
![](/images/from-autoencoder-to-beta-vae/TD-VAE-state-space.png)
...
![](/images/from-autoencoder-to-beta-vae/TD-VAE.png)
