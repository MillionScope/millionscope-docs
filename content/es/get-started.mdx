...
export default {
  project: {
    link: 'https://github.com/millionscope/millionscope.github.io' // GitHub link in the navbar
  },
  docsRepositoryBase: 'https://github.com/millionscope/millionscope.github.io/blob/master', // base URL for the docs repository
...
> title. <br /> Check the source code: https://github.com/millionscope/millionscope.github.io for
> more information.
